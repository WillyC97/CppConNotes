...
* Speaker: Amir Kirsh
* Talk: [Object-Oriented Programming](https://www.youtube.com/watch?v=i_Z_o9T2fNE&ab_channel=CppCon)

### Key Ideas

#### LValue Reference

An Lvalue reference is a value that **will** stay alive at the end of an operation.

```
std::string str2 = str1;
```
Both `str2` and `str1` are lvalue references

#### RValue Reference

An Rvalue reference is a value that will **NOT** stay alive at the end of an operation.

```
std::string str2 = str2 + str1;
```

`str2 + str1` is an RValue reference
